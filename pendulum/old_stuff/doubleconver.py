...
make_kernel_circle(0.47*k_sz, k_sz, pos_w*scaler, big_kernel)
make_kernel_circle(0.45*k_sz, k_sz, pos_w*scaler, big_kernel)
make_kernel_circle(0.43*k_sz, k_sz, pos_w*scaler, big_kernel)
make_kernel_circle(0.38*k_sz, k_sz, neg_w*scaler, big_kernel)
make_kernel_circle(0.36*k_sz, k_sz, neg_w*scaler, big_kernel)
# make_kernel_circle(0.31*k_sz, k_sz, pos_w*scaler, big_kernel)
# make_kernel_circle(0.29*k_sz, k_sz, pos_w*scaler, big_kernel)
# make_kernel_circle(0.27*k_sz, k_sz, pos_w*scaler, big_kernel)
# make_kernel_circle(0.23*k_sz, k_sz, neg_w*scaler, big_kernel)
# make_kernel_circle(0.21*k_sz, k_sz, neg_w*scaler, big_kernel)
# make_kernel_circle(0.17*k_sz, k_sz, pos_w*scaler, big_kernel)
# make_kernel_circle(0.15*k_sz, k_sz, pos_w*scaler, big_kernel)
# make_kernel_circle(0.13*k_sz, k_sz, pos_w*scaler, big_kernel)
