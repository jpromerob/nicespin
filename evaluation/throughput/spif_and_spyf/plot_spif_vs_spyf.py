...
def parse_args():
    ...
    parser.add_argument('-i', '--filename-spif', type= str, help="File name", default="spif_no_callback.csv")
    parser.add_argument('-y', '--filename-spyf', type= str, help="File name", default="spif_callback.csv")
