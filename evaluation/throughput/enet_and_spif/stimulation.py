...
class Stimulator:
    def __init__(self, args, input_q, end_of_sim):
        ...
        self.t_sleeper_array = np.concatenate((np.logspace(3.9,1.6,200), np.logspace(1.6,-1,20)))
        # self.t_sleeper_array = [10000, 1000, 100, 10,1,0.1,0.01]
        self.spin_waiter = 30
