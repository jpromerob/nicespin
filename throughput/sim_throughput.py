...
if __name__ == '__main__':
    ...
    filename = mode + "_" + str(args.length) + "x" + str(args.length) + "_w" + str(args.weight) + "_" + current_datetime.strftime("%Y%m%d_%Hh%M") +".csv"
    ...
    disp = Display(args, input_q, output_q, end_of_sim, stim, filename)
